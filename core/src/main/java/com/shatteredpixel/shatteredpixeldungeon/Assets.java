...
public class Assets {
	...
	public static class Music {
		...
		// Heist music system — folder-based track packs
		// Each entry is a folder name inside music/ containing all phase files.
		// To add a new soundtrack, create a folder and add its name here.
		//
		// Required files per folder:
		// stealth_intro.ogg, stealth_loop.ogg
		// control_intro.ogg, control_loop.ogg
		// anticipation_intro.ogg, anticipation_loop.ogg
		// assault_intro.ogg, assault_loop.ogg
		//
		// Note: shop_intro.ogg and shop_loop.ogg are shared across all tracks
		// and should be placed directly in the music/ directory.

		public static final String HEIST_MUSIC_DIR = "music/";
		public static final String[] HEIST_TRACKS = {
				"NRFTW", // Biome 1 (Sewers)
				"RubyRuse", // Biome 2 (Prison)
				"Contra", // Biome 3 (Caves)
				"IcePunch", // Biome 4 (City)
				"SkyHighScore" // Biome 5 (Halls)
		};
	}
	...
	public static class Sounds {
		...
		public static final String HIT_Chimano88 = "sounds/hit_chimano88.mp3";
